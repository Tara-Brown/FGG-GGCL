...
from chemprop.models.molecule_fragment import *
...
if __name__ == "__main__":
    ...
    root = '/home/cassie/macfrag/data'
    # root = 'J:/hgraph2graph-master/hgraph2graph-master/dataset/chembl'
    task_name_list = ['bbbp','sider', 'bace', 'clintox', 'esol', 'freesolv', 'lipo', 'tox21', 'toxcast']
    ...
    for task in task_name_list:
        ...
        g_list, vocab_df = get_vocab(data_df, ncpu=8)
